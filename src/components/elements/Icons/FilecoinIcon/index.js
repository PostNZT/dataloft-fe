...
const FilecoinICon = ({ height = 50  }) => {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" height={height} viewBox="0 0 40 40" enable-background="new 0 0 40 40">
